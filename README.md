...
`bin/plugin -url https://repository.jboss.org/nexus/content/groups/public-jboss/org/jboss/elasticsearch/elasticsearch-river-jira/1.8.5/elasticsearch-river-jira-1.8.5.zip -install elasticsearch-river-jira`.
