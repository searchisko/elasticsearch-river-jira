...
`bin/plugin -url https://repository.jboss.org/nexus/content/groups/public-jboss/org/jboss/elasticsearch/elasticsearch-river-jira/1.5.0/elasticsearch-river-jira-1.5.0.zip -install elasticsearch-river-jira`.
